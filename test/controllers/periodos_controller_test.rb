...
class PeriodosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create periodo" do
    assert_difference('Periodo.count') do
      post periodos_url, params: { periodo: { fechaFin: @periodo.fechaFin, fechaInicio: @periodo.fechaInicio, id_corrida: @periodo.id_corrida, totalCosto: @periodo.totalCosto } }
    end
  ...
  test "should update periodo" do
    patch periodo_url(@periodo), params: { periodo: { fechaFin: @periodo.fechaFin, fechaInicio: @periodo.fechaInicio, id_corrida: @periodo.id_corrida, totalCosto: @periodo.totalCosto } }
